...
const Search = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-7 md:border-r-1 border-slate-300 md:min-h-screen">
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <option value="regularPrice_desc">Price from high to low</option>
              <option value="regularPrice_asc">Price from low to high</option>
      ...
      <div className="mt-5 ml-5 flex-1">
